...
import 'package:portal_pns_flutter/view/screen/surat/widget/log_surat_widget.dart';
import 'package:portal_pns_flutter/view/screen/surat/widget/nota_dinas_widget.dart';
import 'package:responsive_sizer/responsive_sizer.dart';

class HeaderSuratWidget extends StatelessWidget {
  final SuratModel surat;
  const HeaderSuratWidget({Key? key, required this.surat}) : super(key: key);
        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              Expanded(
                child: Text(
                  (surat.catatan != null || surat.catatan != '')
                      ? '-'
                      : surat.catatan!,
                  style: poppinsRegular.copyWith(
                    fontSize: 14.sp,
          ...
          if (surat.statusSurat.toString() != 'null' &&
              surat.posisiNama.toString() != 'null')
            Row(
              ...
              children: [
                ...
                RichText(
                  text: TextSpan(
                    ...
                    children: [
                      TextSpan(
                        text: (surat.status == 'terkirim')
                            ? surat.statusSurat
                            : '${surat.statusSurat} oleh ',
                      ),
                      TextSpan(
                        text: (surat.status != 'terkirim')
                            ? surat.posisiNama
            ...
            children: [
              ...
              InkWell(
                ...
                onTap: () => showDialog<void>(
                  context: context,
                  builder: (context) =>
                      LogSuratWidget(logSurat: surat.logsurat),
                ),
              ),
            ],
          ),
