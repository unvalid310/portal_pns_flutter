...
class PengajuanSuratWidget extends StatefulWidget {
  final SuratModel surat;
  const PengajuanSuratWidget({Key? key, required this.surat}) : super(key: key);

  @override
  State<PengajuanSuratWidget> createState() => _PengajuanSuratWidgetState();
}

class _PengajuanSuratWidgetState extends State<PengajuanSuratWidget> {
